...
export const metadata = {
  title: "Terms of Service | Aisle",
  description: "Terms of service for Aisle wedding planning platform",
};
        ...
        <div className="max-w-3xl mx-auto prose prose-warm">
          <section className="mb-10">
            ...
            <p className="text-warm-600 leading-relaxed mb-4">
              By accessing or using Aisle (&quot;the Service&quot;), operated by Aisle (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;) at aisleboard.com, you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our Service.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-warm-600 leading-relaxed mb-4">
              Aisle is a wedding planning platform that provides tools for couples to organize their wedding, including but not limited to:
            </p>
          ...
          <section className="mb-10">
            ...
            <p className="text-warm-600 leading-relaxed mb-4">
              Aisle offers both free and paid plans. For paid plans:
            </p>
            <ul className="list-disc list-inside text-warm-600 space-y-2">
          ...
          <section className="mb-10">
            ...
            <p className="text-warm-600 leading-relaxed mb-4">
              The Service and its original content (excluding Your Content), features, and functionality are owned by Aisle and are protected by copyright, trademark, and other intellectual property laws. You may not copy, modify, distribute, or create derivative works without our express permission.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-warm-600 leading-relaxed mb-4">
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, AISLE SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR ANY LOSS OF PROFITS OR REVENUES, WHETHER INCURRED DIRECTLY OR INDIRECTLY.
            </p>
            <p className="text-warm-600 leading-relaxed mb-4">
          ...
          <section className="mb-10">
            ...
            <p className="text-warm-600 leading-relaxed mb-4">
              You agree to indemnify and hold harmless Aisle and its officers, directors, employees, and agents from any claims, damages, losses, or expenses arising from your use of the Service or violation of these Terms.
            </p>
          </section>
      ...
      <footer className="py-8 px-8 bg-warm-100 border-t border-warm-200">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xs text-warm-500">
            © {new Date().getFullYear()} Aisle. All rights reserved.
          </p>
        </div>
      </footer>
    </main>
