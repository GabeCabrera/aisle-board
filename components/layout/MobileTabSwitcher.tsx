...
import { useBrowser, getToolById, AisleLogo } from "./browser-context";
  ...
  return (
    ...
    >
      ...
      <button onClick={onSelect} className="w-full h-full flex flex-col">
        ...
        >
          {tab.type === "chat" && <AisleLogo size={14} className="text-rose-500" />}
        ...
        <div className="flex-1 p-3 flex items-center justify-center">
          {tab.type === "chat" && (
            <div className="text-center">
              <AisleLogo size={32} className="text-rose-300 mx-auto mb-2" />
